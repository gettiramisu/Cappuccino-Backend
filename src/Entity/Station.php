...
final class Station implements JsonSerializable {
    ...
    public function addStationLanguage(StationLanguage $stationLanguage): static {
        if (!$this->languages->contains(element: $stationLanguage)) {
            $this->languages->add(element: $stationLanguage);
        }
        return $this;
    }
    ...
    public function removeStationLanguage(StationLanguage $stationLanguage): static {
        $this->languages->removeElement(element: $stationLanguage);
        return $this;
    }
    ...
    public function jsonSerialize(): array {
        return [
            ...
            'country' => $this->stationCountry->getCode(),
            'languages' => array_map(callback: fn(StationLanguage $stationLanguage) => $stationLanguage->getCode(), array: $this->languages->toArray()),
            'tags' => array_map(callback: fn(StationTag $stationTag) => $stationTag->getName(), array: $this->stationTags->toArray())
        ];
    }
}
