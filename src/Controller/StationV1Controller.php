...
final class StationV1Controller extends AbstractController {
    ...
    public function countries(): JsonResponse {
        $stationCountries = $this->entityManager->getRepository(className: StationCountry::class)->findBy(criteria: [], orderBy: ['code' => 'ASC']);
        return new JsonResponse(array_map(callback: fn(StationCountry $stationCountry) => $stationCountry->getCode(), array: $stationCountries));
    }
    ...
    public function languages(): JsonResponse {
        $stationLanguages = $this->entityManager->getRepository(className: StationLanguage::class)->findBy(criteria: [], orderBy: ['code' => 'ASC']);
        return new JsonResponse(array_map(callback: fn(StationLanguage $stationLanguage) => $stationLanguage->getCode(), array: $stationLanguages));
    }
    ...
    public function tags(): JsonResponse {
        return new JsonResponse(StationTag::ALLOWED_TAGS);
    }
}
