...
final class Version20260205214000 extends AbstractMigration {
    ...
    public function up(Schema $schema): void {
        $this->addSql('CREATE TABLE station_countries (id SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, code VARCHAR(2) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_DFE285B677153098 ON station_countries (code)');
        $this->addSql('CREATE TABLE station_languages (id SMALLINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, code VARCHAR(2) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_22553D6277153098 ON station_languages (code)');
