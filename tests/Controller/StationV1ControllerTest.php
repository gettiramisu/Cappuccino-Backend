...
class StationV1ControllerTest extends AbstractTestController {
    ...
    public function testAll(): void {
        ...
        $this->assertSame(expected: 'LU', actual: $page1Data[0]['country']);
        $this->assertSame(expected: ['lb'], actual: $page1Data[0]['languages']);
        $this->assertSame(expected: ['pop', 'rock'], actual: $page1Data[0]['tags']);
        ...
        $this->assertSame(expected: 'LU', actual: $page2Data[0]['country']);
        $this->assertSame(expected: ['lb'], actual: $page2Data[0]['languages']);
        $this->assertSame(expected: ['pop', 'rock'], actual: $page2Data[0]['tags']);
    }
    ...
    public function testSearchByName(): void {
        ...
        $this->assertSame(expected: 'LU', actual: $data[0]['country']);
        $this->assertSame(expected: ['lb'], actual: $data[0]['languages']);
        $this->assertSame(expected: [], actual: $data[0]['tags']);
    ...
    public function testSearchByLanguage(): void {
        ...
        $this->assertSame(expected: 'http://example.com/2.png', actual: $data[0]['icon_url']);
        $this->assertSame(expected: 'LU', actual: $data[0]['country']);
        $this->assertSame(expected: ['de'], actual: $data[0]['languages']);
        $this->assertSame(expected: [], actual: $data[0]['tags']);
    }
    ...
    public function testSearchByTag(): void {
        ...
        $this->assertSame(expected: 'LU', actual: $data[0]['country']);
        $this->assertSame(expected: ['lb'], actual: $data[0]['languages']);
        $this->assertSame(expected: ['pop'], actual: $data[0]['tags']);
    }
    ...
    public function testCountries(): void {
        ...
        $this->assertSame(expected: ['DE', 'FR', 'LU'], actual: $responseData);
    }
    ...
    public function testLanguages(): void {
        ...
        $responseData = json_decode(json: $this->client->getResponse()->getContent(), associative: true);
        $this->assertSame(expected: ['de', 'fr', 'lb'], actual: $responseData);
    }

    /**
     * Tests that the tags endpoint returns all tags from the station tag entity.
     */
    public function testTags(): void {
        ...
        $responseData = json_decode(json: $this->client->getResponse()->getContent(), associative: true);
        $this->assertSame(expected: StationTag::ALLOWED_TAGS, actual: $responseData);
    }
}
